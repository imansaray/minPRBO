program planczos_full
        ...
        integer           :: seed(sedsz),herm,mi,mj,chknorm(mlanc)
        ...
        complex(kind=wp), allocatable :: Pj(:,:),Qj(:,:)
        logical :: biortho
...
!!  Saving alpha, beta to array
        if(myrow .eq. 0 .and. mycol .eq. 0) then
           open(10,file='par_lanc_nh_mat_full_4_procs.dat')
           open(11,file='par_fnorm_nh_mat_full_4_procs.dat')
           rewind(10)
           rewind(11)
