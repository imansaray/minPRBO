...
!                    
        ...
        ! Generating the random initial vector , v_0 and v_h
        rand_num = 0.0d0
        rand_num2 = 0.0d0
        ...
        open(10,file='lanc_coeffs.dat')
        open(14,file='fnorm.dat')
        open(11,file='resolvent_exact_m_1000.dat')
        open(111,file='resolvent_lanc_herm_minpro_m_1000_mlanc_400.dat')
        rewind(10)
        rewind(14)
        rewind(11)
        rewind(111)
...
!              H(i,i)= md*mod(i,mi)
         ...
         ! Example from : "The Lanczos Alg with partial reorthogonalization"  H(i,i) = 1.0d0*i**2
               H(i,i) = del_spect*i**1
               if (i .gt. mhalf) then
